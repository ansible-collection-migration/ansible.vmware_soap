...
from ansible_collections.ansible.vmware_soap.tests.unit.compat import mock

import ansible_collections.ansible.vmware_soap.plugins.module_utils.vmware as vmware_module_utils
